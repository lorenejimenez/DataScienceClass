...
## Exercise 1: r preloaded dataset 
...
# Weekly practicals 4: data visualization I 
...
# Weekly practical 5: data visualization II 
...
I know want to know the proportion of diseases in 1980, in Mississippi. I will start by filtering the data again:  
...
I will now make an histogram to visualize that:  
...
# weekly practical 6: data modeling 

For this exercise, I will use again my favorite dataset `olive` from the `dslabs` package.  
...
t.test(as.numeric(chickwts$weight), chickwts$feed, alternative = "two.sided", paired = FALSE) 

all(duplicated(chickwts2$weight)[-1L]) 
